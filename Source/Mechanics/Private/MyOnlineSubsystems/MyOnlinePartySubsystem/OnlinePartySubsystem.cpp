...
UOnlinePartySubsystem::UOnlinePartySubsystem()
{
    ...
    if (Handle.IsValid())
    {
        ...
        this->DelegateHandle_OnPartyJoined = Handle->AddOnPartyJoinedDelegate_Handle(
            FOnPartyJoined::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId) {
        ...
        this->DelegateHandle_OnPartyExited = Handle->AddOnPartyExitedDelegate_Handle(
            FOnPartyExited::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId) {
        ...
        this->DelegateHandle_OnPartyStateChanged = Handle->AddOnPartyStateChangedDelegate_Handle(
            FOnPartyStateChanged::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, EPartyState State, EPartyState PreviousState) {
        ...
        this->DelegateHandle_OnPartyPromotionLockoutChanged = Handle->AddOnPartyPromotionLockoutChangedDelegate_Handle(
            FOnPartyPromotionLockoutChanged::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, const bool bLockoutState) {
        ...
        this->DelegateHandle_OnPartyConfigChanged = Handle->AddOnPartyConfigChangedDelegate_Handle(
            FOnPartyConfigChanged::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, const FPartyConfiguration& PartyConfig) {
        ...
        this->DelegateHandle_OnPartyDataReceived = Handle->AddOnPartyDataReceivedDelegate_Handle(
            FOnPartyDataReceived::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, const FName& Namespace, const FOnlinePartyData& PartyData) {
        ...
        this->DelegateHandle_OnPartyMemberPromoted = Handle->AddOnPartyMemberPromotedDelegate_Handle(
            FOnPartyMemberPromoted::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, const FUniqueNetId& NewLeaderId) {
        ...
        this->DelegateHandle_OnPartyMemberExited = Handle->AddOnPartyMemberExitedDelegate_Handle(
            FOnPartyMemberExited::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, const FUniqueNetId& MemberId, const EMemberExitedReason Reason) {
        ...
        this->DelegateHandle_OnPartyMemberJoined = Handle->AddOnPartyMemberJoinedDelegate_Handle(
            FOnPartyMemberJoined::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, const FUniqueNetId& MemberId) {
        ...
        this->DelegateHandle_OnPartyMemberDataReceived = Handle->AddOnPartyMemberDataReceivedDelegate_Handle(
            FOnPartyMemberDataReceived::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, const FUniqueNetId& MemberId, const FName& Namespace, const FOnlinePartyData& PartyData) {
        ...
        this->DelegateHandle_OnPartyInvitesChanged = Handle->AddOnPartyInvitesChangedDelegate_Handle(
            FOnPartyInvitesChanged::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId) {
        ...
        this->DelegateHandle_OnPartyInviteRequestReceived = Handle->AddOnPartyInviteRequestReceivedDelegate_Handle(
            FOnPartyInviteRequestReceived::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, const FUniqueNetId& SenderId, const FUniqueNetId& RequestForId) {
        ...
        this->DelegateHandle_OnPartyInviteReceivedEx = Handle->AddOnPartyInviteReceivedExDelegate_Handle(
            FOnPartyInviteReceivedEx::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const IOnlinePartyJoinInfo& Invitation) {
        ...
        this->DelegateHandle_OnFillPartyJoinRequestData = Handle->AddOnFillPartyJoinRequestDataDelegate_Handle(
            FOnFillPartyJoinRequestData::FDelegate::CreateLambda([this](const FUniqueNetId& LocalUserId, const FOnlinePartyId& PartyId, FOnlinePartyData& PartyData) {
...
void UOnlinePartySubsystemQueryPartyJoinability::Activate()
{
    ...
    auto __DelegateHandle_OnQueryPartyJoinabilityComplete = nullptr;
