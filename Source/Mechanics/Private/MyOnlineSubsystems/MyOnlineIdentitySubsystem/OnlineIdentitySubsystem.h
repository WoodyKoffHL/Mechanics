...
class MECHANICS_API UOnlineIdentitySubsystem : public UGameInstanceSubsystem
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintPure, Category = "MyOnlineSubsystem|Identity")
    bool IsSubsystemAvailable();

    UPROPERTY(BlueprintAssignable, Category = "MyOnlineSubsystem|Identity")
    ...
    UFUNCTION(BlueprintCallable, Category = "MyOnlineSubsystem|Identity")
...
UCLASS()
class MECHANICS_API UOnlineIdentitySubsystemLogin : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, Category = "MyOnlineSubsystem|Identity", meta = (BlueprintInternalUseOnly = "true"))
...
UCLASS()
class MECHANICS_API UOnlineIdentitySubsystemLogout : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
UCLASS()
class MECHANICS_API UOnlineIdentitySubsystemAutoLogin : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
UCLASS()
class MECHANICS_API UOnlineIdentitySubsystemRevokeAuthToken : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
UCLASS()
class MECHANICS_API UOnlineIdentitySubsystemGetUserPrivilege : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
