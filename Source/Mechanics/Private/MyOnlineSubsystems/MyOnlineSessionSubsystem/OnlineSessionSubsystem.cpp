    ...
    if (Handle.IsValid())
    {
        for (auto i = 0; i < MAX_LOCAL_PLAYERS; i++)
        {
            this->DelegateHandle_OnFindFriendSessionComplete.Add(Handle->AddOnFindFriendSessionCompleteDelegate_Handle(
                i,
                FOnFindFriendSessionComplete::FDelegate::CreateLambda([this, i](int32 _UnusedLocalUserNum, bool bWasSuccessful, const TArray<FOnlineSessionSearchResult>& FriendSearchResult) {
        ...
        this->DelegateHandle_OnCreateSessionComplete = Handle->AddOnCreateSessionCompleteDelegate_Handle(
            FOnCreateSessionComplete::FDelegate::CreateLambda([this](FName SessionName, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnStartSessionComplete = Handle->AddOnStartSessionCompleteDelegate_Handle(
            FOnStartSessionComplete::FDelegate::CreateLambda([this](FName SessionName, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnUpdateSessionComplete = Handle->AddOnUpdateSessionCompleteDelegate_Handle(
            FOnUpdateSessionComplete::FDelegate::CreateLambda([this](FName SessionName, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnEndSessionComplete = Handle->AddOnEndSessionCompleteDelegate_Handle(
            FOnEndSessionComplete::FDelegate::CreateLambda([this](FName SessionName, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnDestroySessionComplete = Handle->AddOnDestroySessionCompleteDelegate_Handle(
            FOnDestroySessionComplete::FDelegate::CreateLambda([this](FName SessionName, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnMatchmakingComplete = Handle->AddOnMatchmakingCompleteDelegate_Handle(
            FOnMatchmakingComplete::FDelegate::CreateLambda([this](FName SessionName, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnCancelMatchmakingComplete = Handle->AddOnCancelMatchmakingCompleteDelegate_Handle(
            FOnCancelMatchmakingComplete::FDelegate::CreateLambda([this](FName SessionName, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnFindSessionsComplete = Handle->AddOnFindSessionsCompleteDelegate_Handle(
            FOnFindSessionsComplete::FDelegate::CreateLambda([this](bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnCancelFindSessionsComplete = Handle->AddOnCancelFindSessionsCompleteDelegate_Handle(
            FOnCancelFindSessionsComplete::FDelegate::CreateLambda([this](bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnPingSearchResultsComplete = Handle->AddOnPingSearchResultsCompleteDelegate_Handle(
            FOnPingSearchResultsComplete::FDelegate::CreateLambda([this](bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnJoinSessionComplete = Handle->AddOnJoinSessionCompleteDelegate_Handle(
            FOnJoinSessionComplete::FDelegate::CreateLambda([this](FName SessionName, EOnJoinSessionCompleteResult::Type Result) {
        ...
        this->DelegateHandle_OnQosDataRequested = Handle->AddOnQosDataRequestedDelegate_Handle(
            FOnQosDataRequested::FDelegate::CreateLambda([this](FName Param1) {
        ...
        this->DelegateHandle_OnSessionSettingsUpdated = Handle->AddOnSessionSettingsUpdatedDelegate_Handle(
            FOnSessionSettingsUpdated::FDelegate::CreateLambda([this](FName Param1, const FOnlineSessionSettings& Param2) {
        ...
        this->DelegateHandle_OnSessionParticipantSettingsUpdated = Handle->AddOnSessionParticipantSettingsUpdatedDelegate_Handle(
            FOnSessionParticipantSettingsUpdated::FDelegate::CreateLambda([this](FName Param1, const FUniqueNetId& Param2, const FOnlineSessionSettings& Param3) {
        ...
        this->DelegateHandle_OnSessionUserInviteAccepted = Handle->AddOnSessionUserInviteAcceptedDelegate_Handle(
            FOnSessionUserInviteAccepted::FDelegate::CreateLambda([this](const bool bWasSuccessful, const int32 ControllerId, FUniqueNetIdPtr UserId, const FOnlineSessionSearchResult& InviteResult) {
        ...
        this->DelegateHandle_OnSessionInviteReceived = Handle->AddOnSessionInviteReceivedDelegate_Handle(
            FOnSessionInviteReceived::FDelegate::CreateLambda([this](const FUniqueNetId& UserId, const FUniqueNetId& FromId, const FString& AppId, const FOnlineSessionSearchResult& InviteResult) {
        ...
        this->DelegateHandle_OnRegisterPlayersComplete = Handle->AddOnRegisterPlayersCompleteDelegate_Handle(
            FOnRegisterPlayersComplete::FDelegate::CreateLambda([this](FName SessionName, const TArray<FUniqueNetIdRef>& PlayerIds, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnUnregisterPlayersComplete = Handle->AddOnUnregisterPlayersCompleteDelegate_Handle(
            FOnUnregisterPlayersComplete::FDelegate::CreateLambda([this](FName SessionName, const TArray<FUniqueNetIdRef>& PlayerIds, bool bWasSuccessful) {
        ...
        this->DelegateHandle_OnSessionFailure = Handle->AddOnSessionFailureDelegate_Handle(
            FOnSessionFailure::FDelegate::CreateLambda([this](const FUniqueNetId& PlayerId, ESessionFailure::Type FailureType) {
